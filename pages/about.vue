...
<template>
   <main>
      <h1 class="text-4xl md:text-5xl font-semibold text-gray-600 text-center pt-40">This About Page</h1>
      <p class="text-lg text-gray-400 mt-8 text-center">Wow this awesome!</p>
